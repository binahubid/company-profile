...
const Footer = () => {
  ...
  return (
    <footer className="relative pt-24 pb-12 px-6 md:px-12 lg:px-24 border-t border-black/[0.05] bg-white overflow-hidden">
      ...
      <div className="absolute bottom-0 right-0 w-[500px] h-[500px] bg-[#D9A441]/5 blur-[120px] rounded-full translate-x-1/4 translate-y-1/4 pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-8 mb-24">
          ...
          <div className="lg:col-span-5">
            ...
            <p className="text-[#0B2C6B]/60 text-lg font-light leading-relaxed max-w-md">
          ...
          <div className="lg:col-span-3">
            <h4 className="text-[10px] font-bold tracking-[0.25em] text-[#0B2C6B] uppercase mb-8 opacity-40">
              Navigasi
            </h4>
            <ul className="space-y-4">
              {[
                ...
                <li key={link.label}>
                  ...
                  >
                    <ArrowRight size={14} className="opacity-0 -ml-4 group-hover:opacity-100 group-hover:ml-0 transition-all duration-300 text-[#D9A441]" />
                    {link.label}
                  </Link>
                </li>
              ))}
        ...
        <div className="pt-12 border-t border-black/[0.05] flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-8">
            ...
            <Link href="#" className="text-[10px] text-black/25 hover:text-[#D9A441] transition-colors tracking-widest font-bold uppercase">Syarat & Ketentuan</Link>
          </div>
