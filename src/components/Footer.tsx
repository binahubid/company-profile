...
function FooterCta({ config }: { config: CtaConfig }) {
  ...
  return (
    <div className="relative z-10 mx-auto flex min-h-[360px] max-w-7xl flex-col items-center justify-center px-6 pb-10 pt-20 text-center md:min-h-[420px] md:px-12 md:pb-14 md:pt-28 lg:px-20">
      {config.eyebrow && (
        <p
      ...
      <h2 className={`max-w-4xl text-3xl font-light leading-[1.05] tracking-[-0.04em] md:text-5xl lg:text-6xl ${textClass}`}>
        {config.title}
      </h2>
      {config.description && (
        <p className={`mt-6 max-w-2xl text-sm font-light leading-relaxed md:text-lg ${descriptionClass}`}>
          {config.description}
        </p>
      )}
      <div className="mt-10 flex w-full max-w-3xl flex-col items-center justify-center gap-4 sm:flex-row">
        <Link
          href={config.primary.href}
          className={`group inline-flex h-14 items-center justify-center gap-3 rounded-full px-8 text-[11px] font-bold uppercase tracking-[0.2em] shadow-xl transition-all duration-300 hover:-translate-y-0.5 active:scale-95 ${primaryClass}`}
        >
        ...
        {config.secondary && (
          <Link
            ...
            className={`group inline-flex h-12 items-center justify-center gap-3 rounded-full px-7 text-[11px] font-bold uppercase tracking-[0.18em] shadow-sm transition-all duration-300 hover:-translate-y-0.5 ${secondaryClass}`}
          >
...
const Footer = () => {
  ...
  if (!ctaConfig) {
    return (
      <footer className="relative overflow-hidden border-t border-black/[0.04] bg-[linear-gradient(to_bottom,#FFFFFF,#FAFBFC)] px-6 pb-12 pt-24 text-[#0B2C6B] md:px-12 lg:px-16">
  ...
  return (
    <footer className={`relative z-20 flex min-h-[820px] flex-col overflow-hidden ${sectionClass}`}>
      <Image
        src={ctaBackground}
        alt=""
        fill
      ...
      <div className="relative z-10 mt-auto px-4 pb-0 md:px-8">
        <div className="mx-auto max-w-[1720px] rounded-t-[18px] rounded-b-none bg-[#F7F6EF] px-6 py-10 shadow-[0_-26px_90px_-64px_rgba(0,0,0,0.55)] md:px-12 md:py-12 lg:px-20">
          <FooterContent year={year} />
        </div>
      </div>
    </footer>
