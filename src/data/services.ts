...
const SERVICES_ID: Service[] = [
  {
    ...
    label: "INSIGHTS",
    title: "BinaInsights",
    desc: "Self Awareness & Insights Discovery. Membantu individu dan tim memahami diri mereka maupun lingkungannya dengan lebih baik untuk mendorong pertumbuhan yang lebih cerdas.",
  ...
  },
  {
    ...
    label: "JOURNEY",
    title: "BinaJourney",
    desc: "Beyond travel. Real transformation. Perjalanan terpandu yang dirancang bukan hanya untuk menciptakan kenangan, tetapi untuk menghadirkan kejelasan, tujuan, dan transformasi diri.",
...
const SERVICES_EN: Service[] = [
  {
    ...
    label: "INSIGHTS",
    title: "BinaInsights",
    desc: "Self Awareness & Insights Discovery. Helps individuals and teams understand themselves and their surroundings more clearly so growth decisions become sharper.",
  ...
  },
  {
    ...
    label: "JOURNEY",
    title: "BinaJourney",
    desc: "Beyond travel. Real transformation. Guided journeys designed not only for memories, but for clarity, purpose, and personal transformation.",
