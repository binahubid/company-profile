...
export default function AboutPage() {
  return (
    <div className="bg-[#F5F7FA] text-[#4A4C54] font-sans antialiased overflow-x-hidden">
            ...
            <div className="lg:col-span-7 grid md:grid-cols-2 gap-4">
              {CHALLENGES.map((challenge, i) => (
                <motion.div 
                  ...
                  className="bg-[#F5F7FA] p-8 rounded-2xl border border-black/[0.03] flex items-start gap-4 hover:border-[#D9A441]/40 transition-colors"
                >
              ...
              <div className="bg-[#0B2C6B] p-8 rounded-2xl text-white flex flex-col justify-center">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-12 gap-6 h-full md:h-[600px]">
            ...
            <motion.div 
              ...
              className="md:col-span-7 bg-[#0B2C6B] rounded-[48px] p-12 md:p-16 text-white relative overflow-hidden group shadow-2xl shadow-[#0B2C6B]/20 h-full flex flex-col"
            >
              <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-[#D9A441]/5 blur-[120px] rounded-full translate-x-20 -translate-y-20 group-hover:bg-[#D9A441]/10 transition-colors duration-1000" />
              <div className="relative z-10 flex flex-col h-full">
                <Target size={40} className="text-[#D9A441] mb-12" />
            ...
            >
              <div className="relative z-10 flex flex-col h-full">
                <Compass size={40} className="text-[#0B2C6B] mb-12" />
                <h3 className="text-[11px] font-bold tracking-[0.4em] text-black/40 uppercase mb-6">Misi Kami</h3>
                <h4 className="text-3xl md:text-4xl font-light leading-[1.1] text-[#0B2C6B] tracking-tight mb-8">
                  Mendorong transformasi manusia dan organisasi untuk <span className="text-[#D9A441]">memanusiawikan masa depan.</span>
                </h4>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
            {CAPABILITIES.map((cap, i) => (
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ delay: i * 0.1 }}
                className="group bg-[#F5F7FA] p-10 rounded-[40px] border border-black/[0.03] hover:bg-[#0B2C6B] hover:text-white transition-all duration-500 hover:shadow-2xl hover:shadow-[#0B2C6B]/20"
              >
      ...
      <section className="py-20 md:py-40 px-6 md:px-12 lg:px-20 bg-[#F5F7FA] relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          >
            <div className="inline-block p-4 rounded-3xl bg-white shadow-xl shadow-black/5">
              <Quote className="text-[#D9A441]" size={40} />
            </div>
            <h2 className="text-2xl md:text-5xl font-light text-[#0B2C6B] leading-[1.3] tracking-tight">
              &quot;Bagi kami, memanusiakan masa depan bukan berarti menolak kemajuan. Melainkan memastikan bahwa di tengah kemajuan tersebut, <span className="italic font-normal text-[#D9A441]">manusia tetap menjadi inti</span> dari setiap transformasi.&quot;
            </h2>
            
            <div className="pt-10 flex flex-col md:flex-row items-center justify-center gap-6">
              <Link
                href="/ecosystem"
                className="group h-16 px-12 bg-[#0B2C6B] text-white rounded-full text-[11px] font-bold tracking-[0.3em] hover:scale-105 transition-all items-center justify-center uppercase shadow-2xl shadow-[#0B2C6B]/20 flex"
              >
