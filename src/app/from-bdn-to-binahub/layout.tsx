...
export const metadata: Metadata = {
  ...
  description:
    "Jembatan dari legacy 16 tahun Bina Daya Nusantara menuju ekosistem transformasi BinaHub.",
  alternates: { canonical: "/from-bdn-to-binahub" },
  openGraph: {
    title: "Dari BDN ke BinaHub | BinaHub",
    description:
      "Jembatan dari legacy Bina Daya Nusantara menuju ekosistem transformasi BinaHub.",
