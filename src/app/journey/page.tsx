    ...
    <div className="bg-[#F5F7FA] text-[#4A4C54] font-sans antialiased overflow-x-hidden min-h-screen pt-28 pb-24">
      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10">
        ...
        <header className="mb-24 md:mb-36 border-b border-black/[0.06] pb-12">
          ...
          <h1 className="mt-8 text-6xl sm:text-8xl lg:text-[110px] font-extralight tracking-tighter text-[#0B2C6B] leading-[0.9] uppercase">
            Perjalanan <br />
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-12 gap-8 items-end">
            ...
            <div className="md:col-span-4 flex md:justify-end text-xs tracking-widest text-[#0B2C6B]/50 font-bold uppercase">
              SISTER COMPANY PT BINA DAYA NUSANTARA — SEJAK 2010
            </div>
          </div>
        </header>
        ...
        <div className="space-y-36 md:space-y-48">
          ...
          <section className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-center">
            ...
            <motion.div 
              ...
              className="lg:col-span-6 relative h-[380px] md:h-[500px] w-full rounded-none overflow-hidden shadow-md border border-black/[0.06] group"
            >
              <Image 
                src="/asset/Journey.png" 
          ...
          <section className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-center">
            ...
            <motion.div 
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.8 }}
              className="lg:col-span-6 order-2 lg:order-1 relative h-[380px] md:h-[500px] w-full rounded-none overflow-hidden shadow-md border border-black/[0.06] group"
            >
              <Image 
                src="/asset/Works.png" 
        ...
        <section className="my-36 relative">
          <div className="absolute inset-0 bg-[#0B2C6B] rounded-none scale-105 pointer-events-none shadow-xl" />
