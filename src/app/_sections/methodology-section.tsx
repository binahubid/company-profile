...
const ARCHITECTURE_TABS = [
  ...
  },
  {
    ...
    summary:
      "Membantu organisasi membangun kepemimpinan, sistem kerja, dan budaya yang membuat transformasi dapat berjalan dan terus berkembang secara mandiri.",
    color: "#0B2C6B",
...
const COPY = {
  id: {
    ...
    architecture: "Transformation Architecture by BinaHub",
