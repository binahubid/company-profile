...
const COPY = {
  id: {
    tag: "ALUR KERJA",
    title: "Transformasi sebagai perjalanan, bukan sekedar rangkaian sesi.",
    desc: "Empat langkah ini menjaga proses tetap sederhana bagi peserta, tetapi cukup dalam untuk menghasilkan perubahan perilaku dan dampak yang diharapkan.",
    steps: [
      {
        n: "diagnose",
        title: "Diagnose",
        desc: "Memahami kondisi saat ini dan tantangan unik organisasi Anda.",
        detail: "Melalui BinaInsights, kami menggali karakter, dinamika tim, dan akar permasalahan organisasi. Tahap ini membantu menemukan blind spot berbagai aspek sebelum intervensi dirancang.",
      ...
      },
      {
        ...
        detail: "BinaAcademy merancang kurikulum dan jalur pembelajaran yang menjawab kebutuhan bisnis. Setiap program disusun sebagai sistem, bukan sekedar kelas lepas yang cepat dilupakan.",
      ...
      },
      {
        ...
        detail: "BinaLab dan BinaCoach membangun perubahan perilaku melalui pengalaman, refleksi, dan coaching. Fokusnya adalah membangun kapasitas internal yang lebih kuat.",
      ...
      },
      {
        ...
        detail: "BinaImpact dan BinaWorks memastikan pembelajaran berubah menjadi tindakan, strategi menjadi eksekusi, dan transformasi berjalan secara terukur dan memberikan dampak.",
  ...
  en: {
    tag: "WORKFLOW",
    title: "Transformation as a journey, not just a series of sessions.",
    desc: "These four steps keep the process simple for participants while remaining deep enough to create behavior change and expected impact.",
    steps: [
      {
        n: "diagnose",
        title: "Diagnose",
        desc: "Understand your current condition and your organization's unique challenges.",
        detail: "Through BinaInsights, we uncover character patterns, team dynamics, and organizational root causes. This stage helps reveal blind spots across various aspects before interventions are designed.",
        image: "/asset/Diagnose.png",
      },
      {
        n: "design",
        ...
        detail: "BinaAcademy designs curriculum and learning paths that answer business needs. Every program is built as a system, not just a one-off class that is quickly forgotten.",
        image: "/asset/Design.png",
      },
      {
        n: "develop",
        ...
        detail: "BinaLab and BinaCoach build behavior change through experience, reflection, and coaching. The focus is building stronger internal capacity.",
        image: "/asset/Develop.png",
      },
      {
        n: "deliver",
        ...
        detail: "BinaImpact and BinaWorks ensure learning turns into action, strategy becomes execution, and transformation runs measurably and delivers impact.",
        image: "/asset/Deliver.png",
      },
    ],
  },
