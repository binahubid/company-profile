...
const COPY = {
  id: {
    ...
    heroDesc: "Kami membantu organisasi menyelaraskan strategi, mengembangkan manusia, memperkuat budaya kerja, dan memanfaatkan teknologi agar transformasi berjalan lebih efektif dan memberikan hasil nyata.",
  ...
  en: {
    ...
    heroDesc: "We help organizations align strategies, develop people, strengthen work culture, and leverage technology so transformation runs more effectively and delivers real results.",
